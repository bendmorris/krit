...
template <typename T> T linear(T t) { return t; }
...
// decelerating to zero velocity
template <typename T> T easeOutCubic(T t) { return --t * t * t + 1; }
// acceleration until halfway, then deceleration
...
// decelerating to zero velocity
template <typename T> T easeOutQuart(T t) { return 1 - --t * t * t * t; }
// acceleration until halfway, then deceleration
...
// decelerating to zero velocity
template <typename T> T easeOutQuint(T t) { return 1 + --t * t * t * t * t; }
// acceleration until halfway, then deceleration
